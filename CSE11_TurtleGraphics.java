/*
 * Filename: CSE11_TurtleGraphics.java
 * Author:   Gabrielle Hourany      
 * UserId:   cs11fafg         
 * Date:     9/27/2018
 * Sources of Help: piazza, tutors      
 */
 ...
 */
public class CSE11_TurtleGraphics extends Turtle {
   ...
   */
  public CSE11_TurtleGraphics( World world, int delay ) {
  ...
  public static void main( String[] args ) {
    ...
    CSE11_TurtleGraphics myTurtle = new CSE11_TurtleGraphics( world, DELAY );
    myTurtle.setPenWidth( PEN_WIDTH );


    // Line 1 - Display digits 0 through 9
    ...
    x = x + SEGMENT_LENGTH + DISPLAY_SPACING; //Moves start position right
    myTurtle.draw9( x, y ); // 9 and G are identical in seven segment displays

    x = x + SEGMENT_LENGTH + DISPLAY_SPACING; //Moves start position right
    myTurtle.draw0( x, y ); // 0 and o are identical in seven segment displays
